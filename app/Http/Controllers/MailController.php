...
class MailController extends Controller
{
    public function inbox()
    {
        try {
            ...
            return view('lead.mail.index', compact('mails'));
        } catch (\Exception $e) {
    ...
    public function drafts()
    {
        try {
            ...
            return view('lead.mail.drafts', compact('drafts'));
        } catch (\Exception $e) {
    ...
    public function trash()
    {
        try {
            ...
            return view('lead.mail.trash', compact('trashMails'));
        } catch (\Exception $e) {
    ...
    public function show($id)
    {
        try {
            ...
            return view('lead.mail.view', compact('mail', 'attachments'));
        } catch (\Exception $e) {
