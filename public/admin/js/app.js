!(function (n) {
    ...
    n("#side-menu").metisMenu(),
        ...
        n(window).on("load", function () {
            ...
            document.body.hasAttribute(!1) && c("topbar-color-light"),
        ...
        n("#mode-setting-btn").on("click", function (t) {
            a.hasAttribute("data-bs-theme") &&
                "dark" == a.getAttribute("data-bs-theme")
        ...
        r.hasAttribute("data-layout") &&
            "horizontal" == r.getAttribute("data-layout")
            ? (c("layout-horizontal"), n(".sidebar-setting").hide())
            : c("layout-vertical"),
        document.documentElement.hasAttribute("data-theme-mode") &&
            "purple" == document.documentElement.getAttribute("data-theme-mode")
            ? c("theme-purple")
            : document.documentElement.hasAttribute("data-theme-mode") &&
                "red" == document.documentElement.getAttribute("data-theme-mode")
                ? c("theme-red")
                : c("theme-default"),
        a.hasAttribute("data-bs-theme") &&
            "dark" == a.getAttribute("data-bs-theme")
        ...
        r.hasAttribute("data-layout-size") &&
            ...
            ? c("layout-width-boxed")
            : c("layout-width-fuild"),
        r.hasAttribute("data-layout-scrollable") &&
            "true" == r.getAttribute("data-layout-scrollable")
            ? c("layout-position-scrollable")
            : c("layout-position-fixed"),
        "light" != r.getAttribute("data-topbar") &&
        ...
        r.hasAttribute("data-sidebar") &&
            "brand" == r.getAttribute("data-sidebar")
        ...
        document.getElementsByTagName("html")[0].hasAttribute("dir") &&
            ...
            ? c("layout-direction-rtl")
            : c("layout-direction-ltr"),
...
// Run after every redraw (pagination, search, sort)
...
window.addEventListener("resize", toggleStriped);
