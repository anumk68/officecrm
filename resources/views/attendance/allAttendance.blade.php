            ...
            <div class="row">
                <div class="col-lg-12">
                    <main class="main-content">
                        <div class="email-header attendance-header">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h4 class="mb-0"><i class="fa-solid fa-list-check"></i> All Employees Attendance Record
                                    </h4>
                             ...
                             <div class="row">
                                    ...
                                    <form action="" method="GET" class="row g-3 mb-3">
                                        ...
                                        <div class="col-auto d-flex align-items-end">
                                            ...
                                            @if(request()->has('from') || request()->has('to'))
                                                <a href="{{ route('forManagerAttendance') }}" class="btn btn-secondary ms-2">
                                                    Reset
                                                </a>
                                            @endif
                                        </div>
                                ...
                                <div class="card-body col-md-4">
                                    @if (auth()->user()->role === 'manager' || auth()->user()->role === 'hr')
                                        <form action="{{ route('attendance.export') }}" method="GET" style="float: inline-end;"
                                            class="row g-2 mb-3">
                                            <div class="col-auto">
                                                <label>From</label>
