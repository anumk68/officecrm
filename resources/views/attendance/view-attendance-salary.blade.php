            ...
            <div class="row p-4">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header attendance-header d-flex justify-content-between align-items-center">
                                    <h3>Attendance History for - {{ $selectedMonth }} - {{ $stats['employeename'] ?? '' }}
                                    </h3>

                                    <form method="GET"
                                        action="{{ route('view.employees.attendance', $stats['employeeId']) }}"
                                        class="attendance-month-form">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-blue"><i class="fas fa-calendar-alt"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-green"><i class="fas fa-user-check"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-red"><i class="fas fa-user-times"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-orange"><i class="fas fa-plane-departure"></i>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-purple"><i class="fas fa-clock"></i></div>
                                                <div class="stats-title">Half & Short Leaves</div>
                                                <div class="stats-value">{{ $stats['half_leave_count'] }}</div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-blue"><i class="fas fa-calendar-day"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-green"><i class="fas fa-briefcase"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-orange"><i class="fas fa-wallet"></i></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-green"><i class="fas fa-money-bill-wave"></i>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-blue"><i class="fas fa-coins"></i></div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="stats-card">
                                                <div class="stats-icon icon-purple"><i class="fas fa-comment-dots"></i>
                                                </div>
                                                <div class="stats-title">
                                                    <a href="{{ route('addAttendance.remark', ['user_id' => $stats['employeeId'], 'year' => date('Y'), 'month' => date('m')]) }}"
                                                        class="text-decoration-none">Add Remarks</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
