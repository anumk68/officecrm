                        ...
                        <form id="employeeEditForm" action="{{ route('employees.update', $employee->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        <label>Name</label>
                                        <input name="name" value="{{ $employee->full_name }}" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control">
                                            ...
                                            <option value="web_development"
                                                {{ $employee->department == 'web_development' ? 'selected' : '' }}>
                                                Web Development
                                            </option>
                                            <option value="design"
                                                {{ $employee->department == 'design' ? 'selected' : '' }}>
                                                Design
                                            </option>
                                            <option value="seo" {{ $employee->department == 'seo' ? 'selected' : '' }}>
                                                SEO
                                            </option>
                                            <option value="content"
                                                {{ $employee->department == 'content' ? 'selected' : '' }}>
                                                Content
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="role" class="form-select">
                                            ...
                                            <option value="team_leader"
                                                {{ $employee->role == 'team_leader' ? 'selected' : '' }}>Team Leader
                                            </option>
                                            <option value="team_member"
                                                {{ $employee->role == 'team_member' ? 'selected' : '' }}>Team Member
                                            </option>
                                            <option value="hr" {{ $employee->role == 'hr' ? 'selected' : '' }}>HR
                                            </option>

                                            <!-- ✅ NEW Role Added -->
                                            <option value="sales" {{ $employee->role == 'sales' ? 'selected' : '' }}>
                                                Sales
                                            </option>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="per_month_salary" name="per_month_salary" type="number"
                                            ...
                                            value="{{ $employee->per_month_salary }}">
                                    </div>
                                    ...
                                    <div id="editFormError" class="alert alert-danger mt-3 d-none col-lg-8"></div>

                                    <button id="updateBtn" class="btn btn-primary mt-2" style="width: 200px;">
                                        Update Employee
                                    </button>
                                ...
                                <div class="col-md-4 border-start">
                                    ...
                                    <div class="permissions-list" style="max-height: 700px; overflow-y: auto;">
                                        ...
                                        @foreach ($permissions as $group => $items)
                                            ...
                                            @foreach ($items as $key)
                                                <div class="form-check">
                                                    ...
                                                    <label
                                                        class="form-check-label">{{ ucwords(str_replace('_', ' ', $key)) }}</label>
                                                </div>
                                            @endforeach
                                        @endforeach
            ...
            $("#employeeEditForm").on("submit", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        updateBtn.prop("disabled", false).html("Update Employee");
