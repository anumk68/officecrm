                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <span class="blur-password">
                                                {{ $employee->password_view }}
                                            </span>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($employee->pan_card)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/app/public/' . $employee->pan_card) }}"
                                                        alt="PAN Card" class="img-thumbnail" width="150">
                                                </div>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($employee->salary_slip)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/app/public/' . $employee->salary_slip) }}"
                                                        alt="Salary Slip" class="img-thumbnail" width="150">
                                                </div>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($employee->bank_copy)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/app/public/' . $employee->bank_copy) }}"
                                                        alt="Bank Copy" class="img-thumbnail" width="150">
                                                </div>
                                            @else
                                                N/A
                                            @endif
                                            ...
                                            @if ($employee->previous_experience_letter)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/app/public/' . $employee->previous_experience_letter) }}"
                                                        alt="Previous Experience Letter Copy" class="img-thumbnail"
                                                        width="150">
                                                </div>
                                            @else
                                                N/A
                                            ...
                                            @if ($employee->previous_offer_letter)
                                                <div class="mt-2">
                                                    <img src="{{ asset('storage/app/public/' . $employee->previous_offer_letter) }}"
                                                        alt="Previous Offer Letter Copy" class="img-thumbnail"
                                                        width="150">
                                                </div>
                                            @else
                                                N/A
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <a href="{{ route('employees.downloadInvoice', $employee->id) }}"
