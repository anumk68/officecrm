...
<script type="module">
    ...
    function showBrowserNotification(data) {
        if (!('Notification' in window) || Notification.permission !== 'granted') {
         ...
         const uniqueTag = data.type + '_' + (data.metadata?.leave_id || data.metadata?.project_id || '') + '_' + Date.now();
    ...
    function startListening() {
        ...
        // 2. If the user has a supervisory role, ALSO listen on the shared channel
