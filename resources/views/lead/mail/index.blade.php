    ...
    <div class="modal fade" id="composeModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('mails.store') }}" method="POST" id="composeForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="action" value="draft" id="draftBtn" class="btn btn-warning">
                            <i class="fas fa-save me-1"></i> Save Draft
                        </button>

                        <button type="submit" name="action" value="send" id="sendBtn" class="btn btn-primary">
