                                ...
                                <table id="datatable" class="table table-bordered table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @foreach ($contacts as $index => $contact)
                                            <tr>
                                                <td><input type="checkbox" class="contact-checkbox"
                                                        value="{{ $contact->phone_number }}"></td>
                                                <td>{{ $index + 1 }}</td>
            ...
            <form action="{{ route('whatsapp.send.post') }}" method="POST" id="composeForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Compose WhatsApp Message</h5><button type="button" class="btn-close"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="recipient-display" class="border rounded p-2 bg-light"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateContactSelection() {
                const selectedNumbers = Array.from(checkboxes).filter(cb => cb.checked).map(cb => cb.value).filter(
                    Boolean);
                ...
                if (selectedNumbers.length === 0) {
                    ...
                    recipientDisplay.innerHTML = selectedNumbers.map(n =>
